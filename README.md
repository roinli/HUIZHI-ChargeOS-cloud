...
[帮助文档](http://wenhui.huizhidata.com/category/26) |
...
### 📝 介绍
HGCT开源充电桩平台是一款全开源可商用的系统，前后端分离开发，在小程序、公众号、H5、APP、PC端都能用，使用方便，二开方便！安装使用也很简单！使用文档、接口文档、数据字典、二开文档，就算你是技术小白，也能轻松上手！

欢迎大家来体验、来提建议，来一起让 HGCT开源充电桩平台 更强大，让更多开发者受益！虽然是开源，但我们该有的功能全都有！

   


#### 🖥 加群+v:jinglidream（如果您也对开源感兴趣，欢迎加入群,加群请注明原因），开源、共享、共赢永远是主旋律。
